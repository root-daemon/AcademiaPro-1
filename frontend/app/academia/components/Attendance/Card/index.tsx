...
export default function AttendanceCard({
	...
	continuous,
	delay,
}: { attendance: AttendanceCourse; continuous?: boolean; delay?: number }) {
	const {
		courseTitle,
		category,
		hoursConducted,
	...
	const percentage = Number.parseFloat(attendancePercentage);
